...
description: A practical guide to choosing the right conventional commit type, with clear rules of thumb and examples for each type — helping you write more meaningful commit messages.
tags: ['git']
keywords:
  [
